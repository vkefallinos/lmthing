...
export class StatefulPrompt extends StreamTextBuilder {
   ...
   * @category Hooks
   *
   * @returns Array of all state key names
   */
  getStateKeys(): string[] {
    return this._stateManager.keys();
  }
...
Return only the JSON object in your response, without any additional text or explanation.`;
  ...
  private _getPromptMethods() {
    return {
      ...
      getStateKeys: this.getStateKeys.bind(this),
      getStateSnapshot: this.getStateSnapshot.bind(this),
